...
public class TestArrayList extends Frame implements ItemListener, ActionListener {
	...
	private ArrayOrderedList<Integer> OList; //排序线性表
	private ArrayUnorderedList<Integer> UList; //未排序线性表
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() instanceof Button) { //点击确定按纽事件
			...
			if (bt == bOK1) { //输入一个整数面板的确定按纽,先获取整数data
				Integer data = new Integer(Integer.parseInt(tf1.getText()));
				switch (operation) {
					case 1: // 增加
						OList.add(data);
						break;
